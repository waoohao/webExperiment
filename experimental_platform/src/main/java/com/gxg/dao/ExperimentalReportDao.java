...
public class ExperimentalReportDao {
    ...
    public void insertExperimentalReport(ExperimentalReport experimentalReport) {
        ...
        jdbcTemplate.update(sql,
                experimentalReport.getId(),
                experimentalReport.getTitle(),
                experimentalReport.getName(),
                experimentalReport.getCreateTime(),
                experimentalReport.getExperimentalId(),
                experimentalReport.getExperimentalScore(),
                experimentalReport.getStudentName(),
                experimentalReport.getStudentId()
        );
    }
    ...
    public void updateExperimentalReportScoreById(String id,String score){
        ...
        jdbcTemplate.update(sql,new Object[]{score,id});
