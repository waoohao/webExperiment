...
//            return "error:没有用户！";
    ...
    @ResponseBody
    public String uploadExperimentalReport(@RequestParam("uploadExperimentalReportFormExperimentalId") String experimentalId,
                                           @RequestParam("uploadExperimentalReportFormExperimentalNameInput") String experimentalReportName,
                                           @RequestParam("uploadStudentIdInput") String studentId,
                                           @RequestParam("uploadStudentNameInput") String studentName,
                                           @RequestParam("uploadExperimentalReportFormInput") MultipartFile experimentalReport,
        ...
        System.out.println(getEncodingService.getEncoding(studentName));
        return courseService.uploadExperimentalReport(experimentalId, experimentalReportName, experimentalReport,studentId,studentName);
    }

    @PostMapping(value = "/get_experimental_report")
    @ResponseBody
    public String getExperimentalReport(@RequestParam("experimentalId") String experimentalId,
    ...
    @PostMapping(value = "/upload_experimental_report_score")
    @ResponseBody
    public  String uploadExperimentalReportScore(@RequestParam("SCORE") String score,
                                                 @RequestParam("comment") String comment,
                                                 @RequestParam("Id") String Id){
/*        System.out.println(score);
        System.out.println(comment);*/
        System.out.println(Id);;
        return courseService.uploadExperimentalReportScore(Id,score);
    }

    @PostMapping(value = "/get_experimental_score")
    @ResponseBody
    public String getExperimentalScore(@RequestParam("experimentalId") String experimentalId,
                                       HttpServletRequest request){
        HttpSession session = request.getSession();
        if(session.getAttribute("user") != null) {
            User user = (User)session.getAttribute("user");
        ...
        return courseService.getExperimentalScore(experimentalId);
    }

    @PostMapping(value= "/get_check_work_data")
    @ResponseBody
    public String getExperimentalCheckWorkData(@RequestParam("mouth") String mouth,
        ...
        return courseService.getCheckWorkDate(mouth,year,courseId);
        //return courseService.getExperimentalCheckWorkData(mouthN);
    }

    @PostMapping(value="/upload_check_work")
    @ResponseBody
    public String uploadExperimentalCheckWork(@RequestParam("studentId") String studentId,
        ...
        return courseService.uploadExperimentalCheckWork(experimentalCheckWork);
    }

    @PostMapping("/take_socre_to_excel")
    @ResponseBody
    public String takeScoreToExcel(@RequestParam("courseId") String courseId,
                                   HttpServletRequest request){
        HttpSession session = request.getSession();
        if(session.getAttribute("user") != null) {
            User user = (User)session.getAttribute("user");
        ...
        return courseService.takeScoreToExcel(courseId);
    }
